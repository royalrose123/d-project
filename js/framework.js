...
$(document).ready(function(){
	...
	//下拉框
	$(".btn-select").each(function(index,obj){
		var curSelect = $(obj).find("span")[0];
		var oSelect =  $(obj).find("select")[0];
		var aOption = $(obj).find("option");
	...
	$('.deploy-toggle-class').click(function(){
		var that = $('.booking_popup_m');
		var $this = $(this);
	...
	$('.deploy-toggle-filter').click(function(){
		$(this).parent().find('.filter-content').toggle(100);
