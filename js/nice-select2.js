/* Referrence https://github.com/bluzky/nice-select2/blob/master/docs/index.html */
!(function (e, t) {
            ...
            (a.prototype._renderSelectedItems = function () {
              if (this.multiple) {
                ...
                this.selectedOptions.forEach(function (t) {
                  ...
                  (this.dropdown.querySelector(".multiple-options").innerHTML =
                    e);
              } else {
                var t =
